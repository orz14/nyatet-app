<section>
    ...
    <form wire:submit="saveProfileInfo" autocomplete="off">
        {{-- Nama --}}
        <x-form-input :name="__('name')" wire:model="name" :ph="__('Masukkan Nama Anda')" required>{{ __('Nama') }}</x-form-input>
        
        {{-- Username --}}
        <x-form-input :name="__('username')" wire:model="username" disabled>{{ __('Username') }}</x-form-input>
