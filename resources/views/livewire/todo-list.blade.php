        ...
        <div class="px-3 py-2 card-body">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <x-todo-button wire:click="destroy('{{ $data->slug }}')" class="text-red-600 bg-red-100 hover:bg-red-200">
                    ...
                    @if(!$data->is_done)
                    <x-todo-button wire:click="update('{{ $data->slug }}')" class="text-green-600 bg-green-100 hover:bg-green-200">
